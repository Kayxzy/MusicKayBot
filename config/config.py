...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Kayxzy/MusicKayBot",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/Kaycmngbt"
)  
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/MutualanGroupsChat"
)  

# Set it in True if you want to leave your assistant after a certain amount of time. [Set time via AUTO_LEAVE_ASSISTANT_TIME]
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT", "5000")

# Time after which you're assistant account will leave chats automatically.
AUTO_LEAVE_ASSISTANT_TIME = int(
    getenv("ASSISTANT_LEAVE_TIME", "5000")
)  
